    ...
    public class UpsertRecipeValidator : AbstractValidator<UpsertRecipeCommand>
    {
        public UpsertRecipeValidator(IMessageService messageService)
        {
            ...
            RuleFor(x => x.Items)
                ...
                .WithMessage(messageService.GetMessage(MessageKeys.StockOutReceipt.DuplicateIngredient));
            ...
            RuleForEach(x => x.Items).ChildRules(item =>
            {
                ...
                item.RuleFor(i => i.QuantityPerServing)
                    .GreaterThan(0)
                    .WithMessage(messageService.GetMessage(MessageKeys.StockOutReceipt.QuantityMin));
            });
        }
    }
}
