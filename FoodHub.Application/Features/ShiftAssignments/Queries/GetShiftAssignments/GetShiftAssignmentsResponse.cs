...
{
    /// <summary>
    /// Thông tin một phân công ca trong danh sách.
    /// </summary>
    public class GetShiftAssignmentsResponse : IMapFrom<ShiftAssignment>
    {
        ...
        {
            profile.CreateMap<ShiftAssignment, GetShiftAssignmentsResponse>()
