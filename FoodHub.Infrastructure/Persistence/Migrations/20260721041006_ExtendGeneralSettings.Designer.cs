...
namespace FoodHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260721041006_ExtendGeneralSettings")]
    partial class ExtendGeneralSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodHub.Domain.Entities.BrandingSettings", b =>
                {
                    ...
                    b.Property<bool>("EnableOrdering")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_ordering");

                    b.Property<bool>("EnableReservation")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_reservation");

                    b.Property<bool>("EnableTakeAway")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_take_away");
                    ...
                    b.Property<string>("ZaloOa")
                        ...
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("zalo_oa");

                    b.HasKey("BrandingSettingsId")
                        .HasName("pk_branding_settings");

                    b.HasIndex("Email")
                        .HasDatabaseName("ix_branding_settings_email")
                        .HasFilter("deleted_at IS NULL");

                    b.HasIndex("RestaurantCode")
                        .IsUnique()
                        .HasDatabaseName("ix_branding_settings_restaurant_code")
                        .HasFilter("deleted_at IS NULL");
                    ...
                    b.HasIndex("TaxCode")
                        .HasDatabaseName("ix_branding_settings_tax_code")
                        .HasFilter("deleted_at IS NULL");
            ...
            modelBuilder.Entity("FoodHub.Domain.Entities.OrderPayment", b =>
                {
                    ...
                    b.HasIndex("PaidAt")
                        .HasDatabaseName("ix_order_payments_paid_at");

                    b.HasIndex("PaymentMethodConfigId")
                        .HasDatabaseName("ix_order_payments_payment_method_config_id");
            ...
            modelBuilder.Entity("FoodHub.Domain.Entities.PaymentMethodConfig", b =>
                {
                    b.Property<Guid>("PaymentMethodConfigId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FoodHub.Domain.Entities.OrderPayment", b =>
                {
                    ...
                    b.HasOne("FoodHub.Domain.Entities.PaymentMethodConfig", "PaymentMethodConfig")
                        .WithMany("OrderPayments")
                        .HasForeignKey("PaymentMethodConfigId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_order_payments_payment_method_configs_payment_method_config");
