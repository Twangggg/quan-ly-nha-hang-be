...
namespace FoodHub.Tests.Features.MenuItems
{
    public class CreateMenuItemHandlerTests
    {
        ...
        public async Task Handle_Should_ReturnSuccess_When_MenuItemCreated()
        {
            ...
            var category = new Category { CategoryId = categoryId, Name = "Món chính", CodePrefix = "MC", IsActive = true, CategoryType = CategoryType.Normal };
        ...
        [Fact]
        public async Task Handle_Should_ReturnSuccess_When_CodeAutoGenerated()
        {
            // Arrange
            var categoryId = Guid.NewGuid();
            var command = new CreateMenuItemCommand(
