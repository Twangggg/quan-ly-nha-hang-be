        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_order_employees_created_by",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_order_audit_log", x => x.log_id);
                    table.ForeignKey(
                        name: "fk_order_audit_log_employees_employee_id",
                        column: x => x.employee_id,
                        principalTable: "employees",
                        principalColumn: "employee_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_order_audit_log_order_order_id",
                        column: x => x.order_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_order_audit_log_employee_id",
                table: "order_audit_log",
                column: "employee_id");

            migrationBuilder.CreateIndex(
                name: "ix_order_audit_log_order_id",
                table: "order_audit_log",
                column: "order_id");
